...
python rnn.py %directory% AD all dhc --seq_len=10 --seq_overlap=0.9 --epochs=300 --leave_out=%file_name%
python rnn.py %directory% AD all overall --seq_len=10 --seq_overlap=0.9 --epochs=300 --leave_out=%file_name%
python rnn.py %directory% AD all acts --seq_len=10 --seq_overlap=0.9 --epochs=300 --leave_out=%file_name%
